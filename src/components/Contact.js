...
import linkedinpink from "../assets/linkedinpink.png";
  ...
  return (
    <div class="bg-gradient-to-bl to-[#6d28d9] via-[#000000] from-[#000000] relative items-top justify-center px-5 py-16  sm:items-center " id="Contact">
          ...
          <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 w-4/5 m-auto ">
                  ...
                  <div data-aos="zoom-in-right" data-aos-duration="1000" class="p-6 mr-2 bg-gray-800 rounded-lg border-2 border-gray-500 text-slate-300 text-base text-center transform hover:skew-y-2 hover:scale-[1.03] delay-75 " >
                      ...
                      <div class="flex items-center mt-4 ">
                          <img src={linkedinpink} alt="img" className="w-8 h-8 ml-1 text-[#6d28d9]" />
                          <a href="https://www.linkedin.com/in/driss-elminiar-22537723a/" target="_blank" class="ml-4 text-md tracking-wide font-semibold  text-slate-300">
                              Driss Elminiar
                          </a>
                      </div>
